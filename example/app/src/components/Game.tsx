...
import { EasyEmptySpotlight } from "../resources/svgs";
import { ANNOUNCEMENTPANEL_IMAGE, LOGO_IMAGE } from "../resources/images";
import { CELEBRATION_GIF } from "../resources/gifs";
...
export default function Game() {
  ...
  return (
    <div className="flex items-center justify-center h-full h-full my-auto p-8">
      <EasyEmptySpotlight className="w-52 h-52" />
      <img src={LOGO_IMAGE} alt="Logo" className="w-auto h-32" />
      <img src={CELEBRATION_GIF} alt="Home" className="w-auto h-32" />
      <img
